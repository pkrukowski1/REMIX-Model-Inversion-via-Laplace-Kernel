...
class BaseLearner(object):
    def __init__(self, args, l_cnames=None):
        self._cur_task = -1
    ...
    def _evaluate(self, y_pred, y_true):
        ret = {}
        grouped = accuracy(y_pred.T[0], y_true, self._known_classes, self.args["increment"], increment=20)
        ret["grouped"] = grouped
        ret['by_task'] = grouped['by_task']
    ...
    def _construct_exemplar_unified(self, data_manager, m):
        ...
        for class_idx in range(self._known_classes):
            ...
            class_dset = data_manager.get_dataset(
                [], source="train", mode="test", appendent=(class_data, class_targets), trfm=self.train_trfm
            )
