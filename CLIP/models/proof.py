...
from utils.proof_inc_net import  Proof_Net
# from models.base import BaseLearner
from utils.toolkit import tensor2numpy,get_attribute, accuracy
...
class BaseLearner(object):
    ...
    def _eval_zero_shot(self):  
        self._network.eval()
        class_to_label=self.data_manager.class_names
    ...
    def _construct_exemplar_unified(self, data_manager, m):
        ...
        for class_idx in range(self._known_classes):
            ...
            class_loader = DataLoader(
                class_dset, batch_size=64, shuffle=False, num_workers=4
            )
        ...
        for class_idx in range(self._known_classes, self._total_classes):
            ...
            exemplar_loader = DataLoader(
                exemplar_dset, batch_size=64, shuffle=False, num_workers=4
            )
...
class Learner(BaseLearner):
    ...
    def _eval_cnn(self, loader, tb_logger=None):
