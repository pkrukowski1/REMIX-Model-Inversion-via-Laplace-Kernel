...
class PromptLearner(nn.Module):
    ...
    def ctx_init(self, ctx_init, n_ctx):
        print("init text prompts with a photo of a")
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label=None, known_classes=None, total_classes=None):
        ...
        image_features = self.encode_image(image.type(self.dtype), known_classes=known_classes, total_classes=total_classes)
