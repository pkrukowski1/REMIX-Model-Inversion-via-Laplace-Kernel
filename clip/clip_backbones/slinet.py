...
from clip_backbones.clip.prompt_learner import cfgc, load_clip_to_cpu, TextEncoder, PromptLearner
# from utils.class_names import core50_classnames, domainnet_classnames, cddb_classnames


class SliNet(nn.Module):

    def __init__(self, args, l_cnames):
        ...
        self.classifier_pool = nn.ModuleList([
            PromptLearner(self.cfg, cnames, self.clip_model)
            for cnames in l_cnames
        ])
